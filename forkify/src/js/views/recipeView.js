...
class RecipeView extends View {
  ...
  // Add event listener when the page load and url changed to another one
  ...
  // Add event listener when user update servings
  ...
  // Add event listener when user bookmark a recipe
  ...
  // Generate recipe ingredients HTML
